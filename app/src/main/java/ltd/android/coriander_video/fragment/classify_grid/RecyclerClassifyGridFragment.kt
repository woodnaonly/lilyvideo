 ...
 */
class RecyclerClassifyGridFragment : BaseFragment<BaseViewModel>() {
    ...
    companion object {
        ...
        fun newInstance(Id: Int): RecyclerClassifyGridFragment {
            val fragment = RecyclerClassifyGridFragment()
            val args = Bundle()
            args.putInt(dataName, Id)
    ...
    override fun prepareBeforeInitView() {
        ...
        clsId = arguments?.getInt(dataName)!!
    }
}